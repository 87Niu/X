<template>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
            <router-link class="navbar-brand" :to="{name: 'home'}">X</router-link>
                ...
                <ul class="navbar-nav" v-if="$store.state.user.is_login">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><router-link :class="route_name == 'user_bot_index' ? 'nav-link active' : 'nav-link'" :to="{name: 'user_bot_index'}">My Bot</router-link></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a @click="logout" class="dropdown-item" href="#">Exit</a></li>
                        </ul>
                    </li>
